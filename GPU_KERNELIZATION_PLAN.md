...
| Tail wave 2 (config-gated / harder) | ~15 | ~80 | TODO | cn_products (p2g + DWT scatter + error()), nutrient_competition (FUN/crop state machine), calc_crop_allocation_fractions! (error()+crop_phase!), cndv, c_iso_flux, voc_emission, satellite_phenology, cn_balance_check. Mostly use_fun/use_cndv/use_c13/c14-gated (off in default clm_drv!). |
