# gpu_validate_dustleung_e2e.jl — Leung (2023) dust emission on GPU parity.
#
...
# every input array to GPU and reruns on-device, comparing the
...
if !(dust_d.flx_mss_vrt_dst_patch isa device_array_type())
