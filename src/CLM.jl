...
include("biogeochem/cn_veg_matrix.jl")  # matrix-CN vegetation C/N solver (use_matrixcn)
include("biogeochem/cn_veg_matrix_wiring.jl")  # matrix-CN veg-C accumulation from live flux fields (phase 1)
...
include("biogeochem/fire_li2016.jl")
include("biogeochem/fire_li2021.jl")
include("biogeochem/fire_li2024.jl")
include("biogeochem/fire_nofire.jl")
include("biogeochem/fire_factory.jl")
include("biogeochem/methane.jl")
include("biogeochem/voc_emission.jl")
include("biogeochem/dust_emission.jl")
include("biogeochem/dust_emission_leung2023.jl")
include("biogeochem/dust_emission_factory.jl")
include("biogeochem/satellite_phenology.jl")
include("biogeochem/c_iso_flux.jl")
include("biogeochem/carbon_isotopes.jl")  # C13/C14 tracer: photosynthesis fractionation + C14 decay (use_c13/use_c14)
