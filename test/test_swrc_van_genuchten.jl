@testset "SWRC Van Genuchten 1980" begin
    # ------------------------------------------------------------------
    # Tests for SoilWaterRetentionCurveVanGenuchten1980Mod port.
    # Verifies:
    ...
    swrc = CLM.SoilWaterRetentionCurveVanGenuchten1980()

    # ------------------------------------------------------------------
    # 1. Type hierarchy
    # ------------------------------------------------------------------
    @test swrc isa CLM.SoilWaterRetentionCurve
    @test swrc isa CLM.SoilWaterRetentionCurveVanGenuchten1980
